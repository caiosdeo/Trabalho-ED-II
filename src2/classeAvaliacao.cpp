 ...
 */
Avaliacao* Avaliacao::leituraDados(fstream &dataset, int n){

    // Conjunto de Avaliacaos
    Avaliacao* r = (Avaliacao*)calloc(n, sizeof(Avaliacao));
...
char* Avaliacao::getUser(){

    return this->user;

}

float Avaliacao::getRating(){
