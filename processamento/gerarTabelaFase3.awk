BEGIN{
  ...
  print "\\begin{tabular}{c|c|c|c|c}" >> "tabelaTratadosFase3.tex";
  print "\\textbf{Árvore} &\\textbf{N} & \\textbf{Comparação} & \\textbf{Acessos} & \\textbf{Tempo (ms)}\\\\" >> "tabelaTratadosFase3.tex";
  print "\\hline" >> "tabelaTratadosFase3.tex";

}

{
    print $1, "&", $2, "&", $3, "&", $4, "&", $5 ,"\\\\">> "tabelaTratadosFase3.tex";
}
